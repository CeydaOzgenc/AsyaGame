...
<?php
    ...
    if(!$_SESSION)
    {
        ...
        $sql=mysqli_query($db,"select * from contact_message order by Message_Id ");           
?>
<html>
    <head>
        <meta charset="utf-8" />
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple">
                                            ...
                                            <?php while ($kayit=mysqli_fetch_array($sql)){ ?>
                                                <tr>
                                                    <td><?php echo $kayit["Message_name"]; ?></td>
                                                    <td><?php echo $kayit["Message_mail"]; ?></td>
                                                    <td><?php echo $kayit["Message_titile"]; ?></td>
                                                    <td><?php echo $kayit["Message_text"]; ?></td>
                                                    <td>
                                                        <a href="<?php echo "sil.php?yer=m&sil=".$kayit["Message_Id"] ?>"><input class="btn btn-danger" type="submit" value="Sil"></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                            </tbody>
