...
<?php
    ...
    if(!$_SESSION)
    {
        ...
        $sql=mysqli_query($db,"select * from galery order by  Galery_name ");           
?>
<html>
    <head>
        <meta charset="utf-8" />
                            ...
                            <div class="col-xl-12 col-md-6">
                                <div class="card text-white mb-4">
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple">
                                            ...
                                            <?php while ($kayit=mysqli_fetch_array($sql)){ ?>
                                                <tr>
                                                    <td><?php echo $kayit["Galery_name"]; ?></td>
                                                    <td><img class="admin_img" src="<?php echo '../assets/img/galeri/'.$kayit['Galery_img'];?>"/></td>
                                                    <td>
                                                        <a href="<?php echo "duzen.php?yer=g&duzen=".$kayit["Galery_name"] ?>">
                                                            <input class="btn btn-primary" type="submit" value="Düzenle">
                                                        </a>

                                                        <a href="<?php echo "sil.php?yer=g&sil=".$kayit["Galery_name"] ?>">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white " href="ekle.php?yer=g">Yeni Ekle</a>
