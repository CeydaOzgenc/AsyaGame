...
<?php
    ...
    if(!$_SESSION)
    {
        ...
        $sql=mysqli_query($db,"select * from blog order by  Blog_Id ");           
?>
<html>
    <head>
        <meta charset="utf-8" />
                                ...
                                <div class="card text-white mb-4">
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple">
                                            ...
                                            <tbody>
                                            <?php while ($kayit=mysqli_fetch_array($sql)){ ?>
                                                <tr>
                                                    <td><?php echo $kayit["Blog_category"]; ?></td>
                                                    <td class="blog_img"><img src="<?php echo '../assets/img/blog/'.$kayit['Blog_img']; ?>" /></td>
                                                    <td><?php echo $kayit["Blog_author"]; ?></td>
                                                    <td><?php echo $kayit["Blog_title"]; ?></td>
                                                    <td><?php echo $kayit["Blog_text"]; ?></td>
                                                    <td><?php echo $kayit["Blog_time"]; ?></td>
                                                    <td>
                                                        <a href="<?php echo 'duzen.php?yer=b&duzen='.$kayit["Blog_Id"] ?>">
                                                            <input class="btn btn-primary" type="submit" value="Düzenle">
                                                        </a>
                                                        <a href="<?php echo 'sil.php?yer=b&sil='.$kayit["Blog_Id"] ?>">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white" href="ekle.php?yer=b">Yeni Ekle</a>
