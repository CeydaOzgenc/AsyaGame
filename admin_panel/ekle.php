                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-6">
                                <div class="card text-white mb-4">
                                    ...
                                    if($yer=='og' or $yer=='os'){
                                        echo 'yukle_ekle.php?yer='.$yer.'&oyun='.$oyun;
                                    }
                                    else{
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-xl-6 col-md-6" style="color:#000; margin: 2%;">
                                                ...
                                                <input class="form-control profil-form" type="text" name="resim_ekle_isim">
                                            </div>
                                            <div class="col-xl-6 col-md-6" style="color:#000; margin: 2%;">
                                                <h3>Fotoğraf :</h3><br>
                                            ...
                                            <div class="col-xl-6 col-md-6" style="color:#000; margin: 2%;">
                                                <h3>Katagori:</h3><br>
                                                <input class="form-control profil-form" type="text" name="blog_ekle_katagori">
                                            </div>
                                            <div class="col-xl-6 col-md-6" style="color:#000; margin: 2%;">
                                                <h3>Fotoğraf :</h3><br>
                                                <input class="form-control profil-form" type="file" name="dosya_ekle">
                                            ...
                                            <div class="col-xl-6 col-md-6" style="color:#000; margin: 2%;">
                                                <h3>Yazar:</h3><br>
                                                <input class="form-control profil-form" type="text" name="blog_ekle_yazar">
                                            </div>
                                            <div class="col-xl-6 col-md-6" style="color:#000; margin: 2%;">
                                                <h3>Başlık :</h3><br>
                                                <input class="form-control profil-form" type="text" name="blog_ekle_baslik" >
                                            </div>
                                            <div class="col-xl-6 col-md-6" style="color:#000; margin: 2%;">
                                                <h3>Yazı:</h3><br>
                                                <input class="form-control profil-form" type="text" name="blog_ekle_yazi">
                                            </div>
                                            <div class="col-xl-6 col-md-6" style="color:#000; margin: 2%;">
                                                <h3>Zaman :</h3><br>
                                                <input class="form-control profil-form" type="date" name="blog_ekle_zaman">
                                            </div>
                                            <?php }else if($yer=='a'){
                                            ?>
                                            <div class="col-xl-6 col-md-6" style="color:#000; margin: 2%;">
                                            ...
                                            <div class="col-xl-6 col-md-6" style="color:#000; margin: 2%;">
                                                <h3>Fotoğraf Adı:</h3><br>
                                                <input class="form-control profil-form" type="text" name="foto_ekle_isim">
                                            </div>
                                            <div class="col-xl-6 col-md-6" style="color:#000; margin: 2%;">
                                                <h3>Fotoğraf :</h3><br>
                                                <input class="form-control profil-form" type="file" name="dosya_ekle">
                                            ...
                                            ?>
                                            <div class="col-xl-6 col-md-6" style="color:#000; margin: 2%;">
                                                <h3>Oyun Sayfası İsmi :</h3><br>
                                                <input class="form-control profil-form" type="text" name="oyun_isim">
                                            </div>
                                            <?php } ?>
                                        </div>
