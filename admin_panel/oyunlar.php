...
<?php
    ...
    if(!$_SESSION)
    {
        ...
        $sql=mysqli_query($db,"select * from game order by  Game_Id ");           
?>
<html>
    <head>
        <meta charset="utf-8" />
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand bg-ozel">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="anasayfa.php">
                ...
                <nav class="sb-sidenav accordion nav-ozel" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="oyunlar.php" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                Oyunlar
                            ...
                            <div class="col-xl-12 col-md-6">
                                <div class="card text-white mb-4">
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple">
                                            ...
                                            <?php while ($kayit=mysqli_fetch_array($sql)){ ?>
                                                <tr>
                                                    <td><?php echo $kayit["Game_name"] ?></td>
                                                    <td>
                                                        <a href="<?php echo 'sil.php?yer=o&sil='.$kayit["Game_Id"] ?>">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white" href="ekle.php?yer=o">Yeni Ekle</a>
